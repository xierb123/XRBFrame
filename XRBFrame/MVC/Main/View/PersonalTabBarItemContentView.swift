//
//  PersonalTabBarItemContentView.swift
//  HiconTV
//
...
class PersonalTabBarItemContentView: ESTabBarItemContentView {
    ...
    override init(frame: CGRect) {
        ...
        selectedAnimationView = AnimationView(name: "tab_personal_selected")
        ...
        normalAnimationView = AnimationView(name: "tab_personal_normal")
