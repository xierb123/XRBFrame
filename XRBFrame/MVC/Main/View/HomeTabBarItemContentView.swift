//
//  HomeTabBarItemContentView.swift
//  HiconTV
//
...
class HomeTabBarItemContentView: ESTabBarItemContentView {
    ...
    override init(frame: CGRect) {
        ...
        selectedAnimationView = AnimationView(name: "tab_home_selected")
        ...
        normalAnimationView = AnimationView(name: "tab_home_normal")
        ...
        DispatchQueue.main.async {
            self.selectAnimation(animated: true, completion: nil)
        }
    }
