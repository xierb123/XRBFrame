//
//  LiveTabBarItemContentView.swift
//  HiconTV
//
...
class LiveTabBarItemContentView: ESTabBarItemContentView {
    ...
    override init(frame: CGRect) {
        ...
        selectedAnimationView = AnimationView(name: "tab_live_selected")
        ...
        normalAnimationView = AnimationView(name: "tab_live_normal")
