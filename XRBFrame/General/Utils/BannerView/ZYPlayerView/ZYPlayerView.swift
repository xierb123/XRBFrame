...
extension ZYPlayerView {
    ...
    private func setupBottomView() {
        ...
        self.rightTimeLabel = UILabel(frame: CGRect(x: bottomView.frame.width - 50 - 40, y: bottomView.frame.height / 2 - 10, width: 40, height: 20))
        ...
        let width = bottomView.frame.width - x - 40.0 - 50.0
        ...
        self.fullScreenBtn?.frame = CGRect(x: bottomView.frame.width - 50, y: 0, width: 50, height: 50)
        self.fullScreenBtn?.addTarget(self, action: #selector(fullScreenBtnClick), for: .touchUpInside)
        self.fullScreenBtn?.setImage(ZYPlayerTool.getBoundleImage("fullScreen_icon"), for: .normal)
